...
const skills = [
    ...
    { name: 'Node.js', icon: SiReact, color: '#339933', category: 'Backend' },
    { name: 'Express.js', icon: SiFastapi, color: '#000000', category: 'Backend' },
    { name: 'FastAPI', icon: SiFastapi, color: '#009688', category: 'Backend' },
    { name: 'PostgreSQL', icon: SiPostgresql, color: '#4169E1', category: 'Database' },
    { name: 'MySQL', icon: SiMongodb, color: '#4479A1', category: 'Database' },
    { name: 'Redis', icon: SiMongodb, color: '#DC382D', category: 'Database' },
                ...
                <div className="mt-12 md:mt-16 text-center">
                    <div className="glass-card inline-block px-6 md:px-10 py-4 md:py-5">
                        <p className="text-sm md:text-base" style={{ color: 'var(--text-secondary)' }}>
                            Also experienced with: <span style={{ color: 'var(--accent-primary)' }}>AdminJS</span> • <span style={{ color: 'var(--accent-tertiary)' }}>Webhooks</span> • <span style={{ color: 'var(--accent-pink)' }}>AWS SQS</span> • <span style={{ color: 'var(--accent-primary)' }}>Firebase</span>
                        </p>
                    </div>
                </div>
            </div>
