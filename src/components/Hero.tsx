    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
            ...
            <div className="container mx-auto text-center relative z-10 px-4 py-4">
                ...
                >
                    Expert in <span style={{ color: 'var(--accent-primary)' }}>Node.js</span>, <span style={{ color: 'var(--accent-tertiary)' }}>React</span>, <span style={{ color: 'var(--accent-pink)' }}>Next.js</span> and <span style={{ color: 'var(--accent-blue)' }}>PostgreSQL</span>.
                    Building scalable, efficient web applications with modern full stack architecture.
                </p>
