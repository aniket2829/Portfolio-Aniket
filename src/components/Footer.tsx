...
const socialLinks = [
    { name: 'GitHub', icon: Github, href: 'https://github.com/aniket2829' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/in/aniketdhiman2829' },
    { name: 'Email', icon: Mail, href: 'mailto:anidhiman456@gmail.com' },
];
